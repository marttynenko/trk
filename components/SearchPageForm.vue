  ...
  <div class="search-block">
    <div class="search-block-form">
      <form @submit.prevent="toSearchPage">
        <input type="text" class="search-block-input" :placeholder="$t('hint')" v-model="query" ref="input">
        <button type="submit" class="search-block-btn">{{ $t('hint') }}</button>
      </form>
    </div>
  </div>
</template>
...
.search-block {
  ...
  &-input {
    ...
    &:hover {
      border-bottom-color: darken(#B6B6B6, 12%);
    }
